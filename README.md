...
| 9. Настроить файрвол (nftables)         |
| 10. Тестовый запуск                     |
| 11. Назад в основное меню               |
+-----------------------------------------+
 Ваш выбор: _
```
...
Для обеспечения безопасности блокчейн-сети, скрипт предоставляет возможность автоматической настройки файрвола с использованием nftables. Эта функция доступна через меню утилит и выполняет следующие действия:
...
1. Выберите пункт "Настроить файрвол (nftables)" в меню утилит
